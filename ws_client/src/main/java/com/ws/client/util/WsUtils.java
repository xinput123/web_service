...
public class WsUtils {
    ...
    private final static String namespaceUri = "http://webservice.ws.xinput.com/";

    private final static String methodName = "jtptCommonWebService";
    ...
    public static Object[] wsXiangYaService(String messge) throws Exception {
        try {
